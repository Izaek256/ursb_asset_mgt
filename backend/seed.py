...
# ---------------------------------------------------------------------------
# Path setup — allow running from the project root or the backend/ directory
# ---------------------------------------------------------------------------
...
# Seed helpers
# ---------------------------------------------------------------------------
def get_or_create_user(db, *, email: str, full_name: str, role: UserRole,
                        department: str, password: str) -> User:
...
def get_or_create_asset(db, *, asset_id: str, **kwargs) -> Asset:
    """Return existing asset by asset_id, or create and return a new one."""
...
def seed():
    ...
    try:
        ...
        # ----------------------------------------------------------------
        # 1. USERS — one per role, plus extras for realistic data
        # ----------------------------------------------------------------
        print("\n[1/6] Seeding users...")
        ...
        assets_data = [
            ...
            {
                "asset_id": "AST-ICT00001",
                "asset_name": "Dell Latitude 5540 Laptop",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Laptops",
                "serial_number": "DL5540-UG-001",
                "condition": AssetCondition.NEW,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2024/ICT/001",
                "cost": 3_200_000,
                "acquisition_date": date(2024, 3, 10),
                "supplier": "Dawa Technologies Uganda Ltd",
                "current_custodian_id": custodian1.user_id,
                "department": "ICT",
            },
            {
                "asset_id": "AST-ICT00002",
                "asset_name": "HP LaserJet Pro M404dn Printer",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Printers",
                "serial_number": "HPLJ-M404-002",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2023/ICT/012",
                "cost": 1_450_000,
            ...
            {
                "asset_id": "AST-ICT00003",
                "asset_name": "Cisco Catalyst 2960 Network Switch",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Networking",
                "serial_number": "CSCO-2960-UG-003",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2023/ICT/008",
                "cost": 4_800_000,
                "acquisition_date": date(2023, 1, 20),
                "supplier": "Infocom Networks Uganda",
                "current_custodian_id": custodian1.user_id,
                "department": "ICT",
            },
            {
                "asset_id": "AST-ICT00004",
                "asset_name": "Samsung 55\" LED Conference Room Display",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Displays",
                "serial_number": "SAM-LED55-004",
                "condition": AssetCondition.NEW,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2024/ICT/005",
                "cost": 2_100_000,
            ...
            {
                "asset_id": "AST-ICT00005",
                "asset_name": "APC Smart-UPS 1500VA",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Power Equipment",
                "serial_number": "APC-1500-UG-005",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2022/ICT/019",
                "cost": 1_200_000,
                "acquisition_date": date(2022, 11, 8),
                "supplier": "PowerTech Uganda",
                "current_custodian_id": custodian1.user_id,
                "department": "ICT",
            },
            {
                "asset_id": "AST-ICT00006",
                "asset_name": "Lenovo ThinkCentre Desktop",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Desktop Computers",
                "serial_number": "LNV-TC-006",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2023/ICT/022",
                "cost": 2_500_000,
                "acquisition_date": date(2023, 4, 18),
                "supplier": "Dawa Technologies Uganda Ltd",
                "current_custodian_id": employee1.user_id,
                "department": "Legal",
            },
            {
                "asset_id": "AST-ICT00007",
                "asset_name": "Logitech MeetUp Conference Camera",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Conferencing Equipment",
                "serial_number": "LGT-MTUP-007",
                "condition": AssetCondition.NEW,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2024/ICT/009",
                "cost": 1_800_000,
                "acquisition_date": date(2024, 2, 14),
                "supplier": "Infocom Networks Uganda",
                "current_custodian_id": custodian2.user_id,
                "department": "Administration",
            },
            # --- Furniture (Active) ---
            {
                "asset_id": "AST-FRN00001",
                "asset_name": "Executive Office Desk (Mahogany)",
                "asset_type": AssetType.FURNITURE,
                "category": "Desks",
                "serial_number": "FRN-DESK-008",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2022/ADM/003",
                "cost": 850_000,
                "acquisition_date": date(2022, 6, 1),
                "supplier": "Quality Furniture Uganda",
                "current_custodian_id": custodian2.user_id,
                "department": "Administration",
            },
            {
                "asset_id": "AST-FRN00002",
                "asset_name": "Ergonomic Office Chair (Set of 10)",
                "asset_type": AssetType.FURNITURE,
                "category": "Chairs",
                "serial_number": "FRN-CHAIR-009",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2022/ADM/004",
                "cost": 3_500_000,
                "acquisition_date": date(2022, 6, 1),
                "supplier": "Quality Furniture Uganda",
                "current_custodian_id": custodian2.user_id,
            ...
            {
                "asset_id": "AST-FRN00003",
                "asset_name": "6-Seater Conference Table",
                "asset_type": AssetType.FURNITURE,
                "category": "Tables",
                "serial_number": "FRN-TABLE-010",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2021/ADM/007",
                "cost": 1_200_000,
                "acquisition_date": date(2021, 9, 14),
                "supplier": "Quality Furniture Uganda",
                "current_custodian_id": custodian2.user_id,
                "department": "Registry",
            },
            # --- Vehicles (Active) ---
            {
                "asset_id": "AST-VEH00001",
                "asset_name": "Toyota Land Cruiser Prado (UAG 001A)",
                "asset_type": AssetType.VEHICLE,
                "category": "SUVs",
                "serial_number": "TLC-PRADO-UAG001A",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2021/VEH/001",
                "cost": 120_000_000,
                "acquisition_date": date(2021, 3, 5),
                "supplier": "CFAO Motors Uganda",
                "current_custodian_id": manager.user_id,
                "department": "Finance & Administration",
            },
            {
                "asset_id": "AST-VEH00002",
                "asset_name": "Toyota Hilux Double Cab (UAG 002B)",
                "asset_type": AssetType.VEHICLE,
                "category": "Pick-Up Trucks",
                "serial_number": "TYT-HLUX-UAG002B",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2022/VEH/002",
                "cost": 95_000_000,
                "acquisition_date": date(2022, 8, 22),
                "supplier": "CFAO Motors Uganda",
                "current_custodian_id": employee3.user_id,
                "department": "Finance & Administration",
            },
            # --- Software (Active) ---
            {
                "asset_id": "AST-SFT00001",
                "asset_name": "Microsoft Office 365 Business Premium (25 Seats)",
                "asset_type": AssetType.SOFTWARE,
                "category": "Productivity Software",
                "serial_number": "MS-O365-URSB-2024",
                "condition": AssetCondition.NEW,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2024/SFT/001",
                "cost": 8_750_000,
                "acquisition_date": date(2024, 1, 1),
                "supplier": "Microsoft East Africa",
                "current_custodian_id": admin.user_id,
                "department": "ICT",
            },
            {
                "asset_id": "AST-SFT00002",
                "asset_name": "Kaspersky Endpoint Security (50 Licenses)",
                "asset_type": AssetType.SOFTWARE,
                "category": "Security Software",
                "serial_number": "KSP-ES-URSB-2024",
                "condition": AssetCondition.NEW,
                "status": AssetStatus.ACTIVE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2024/SFT/002",
                "cost": 5_600_000,
            ...
            # --- In Storage ---
            {
                "asset_id": "AST-ICT00008",
                "asset_name": "HP EliteBook 840 G5 Laptop",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Laptops",
                "serial_number": "HP-EB840-015",
                "condition": AssetCondition.REFURBISHED,
                "status": AssetStatus.IN_STORAGE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2020/ICT/031",
                "cost": 2_800_000,
            ...
            {
                "asset_id": "AST-FRN00004",
                "asset_name": "Steel Filing Cabinet (4-Drawer)",
                "asset_type": AssetType.FURNITURE,
                "category": "Storage",
                "serial_number": "FRN-CABINET-016",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.IN_STORAGE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2021/ADM/012",
                "cost": 450_000,
                "acquisition_date": date(2021, 11, 3),
                "supplier": "Quality Furniture Uganda",
                "current_custodian_id": None,
                "department": None,
            },
            {
                "asset_id": "AST-ICT00009",
                "asset_name": "Epson EcoTank L3150 Printer",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Printers",
                "serial_number": "EPS-L3150-017",
                "condition": AssetCondition.GOOD,
                "status": AssetStatus.IN_STORAGE,
                "source_type": SourceType.DONATION,
                "procurement_ref": None,
                "cost": 680_000,
                "acquisition_date": date(2022, 3, 8),
                "supplier": "USAID Uganda Programme",
                "current_custodian_id": None,
                "department": None,
            },
            # --- Under Maintenance ---
            {
                "asset_id": "AST-VEH00003",
                "asset_name": "Isuzu NPR Box Truck (UAG 003C)",
                "asset_type": AssetType.VEHICLE,
                "category": "Trucks",
                "serial_number": "ISZ-NPR-UAG003C",
                "condition": AssetCondition.DAMAGED,
                "status": AssetStatus.UNDER_MAINTENANCE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2019/VEH/003",
                "cost": 75_000_000,
            ...
            {
                "asset_id": "AST-ICT00010",
                "asset_name": "Dell PowerEdge T440 Server",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Servers",
                "serial_number": "DEL-T440-SRV-019",
                "condition": AssetCondition.DAMAGED,
                "status": AssetStatus.UNDER_MAINTENANCE,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2020/ICT/007",
                "cost": 18_500_000,
            ...
            # --- Disposed ---
            {
                "asset_id": "AST-ICT00011",
                "asset_name": "Dell OptiPlex 390 Desktop (EOL)",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Desktop Computers",
                "serial_number": "DEL-OPX390-020",
                "condition": AssetCondition.DAMAGED,
                "status": AssetStatus.DISPOSED,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2015/ICT/003",
                "cost": 1_100_000,
                "acquisition_date": date(2015, 4, 5),
                "supplier": "Dawa Technologies Uganda Ltd",
                "current_custodian_id": None,
                "department": None,
            },
            {
                "asset_id": "AST-FRN00005",
                "asset_name": "Wooden Reception Desk (Old Design)",
                "asset_type": AssetType.FURNITURE,
                "category": "Desks",
                "serial_number": "FRN-RDESK-021",
                "condition": AssetCondition.DAMAGED,
                "status": AssetStatus.DISPOSED,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2012/ADM/001",
                "cost": 600_000,
                "acquisition_date": date(2012, 1, 15),
                "supplier": "Quality Furniture Uganda",
                "current_custodian_id": None,
                "department": None,
            },
            {
                "asset_id": "AST-ICT00012",
                "asset_name": "Compaq Presario Desktop PC",
                "asset_type": AssetType.ICT_EQUIPMENT,
                "category": "Desktop Computers",
                "serial_number": "CPQ-PRES-022",
                "condition": AssetCondition.DAMAGED,
                "status": AssetStatus.DISPOSED,
                "source_type": SourceType.PROCUREMENT,
                "procurement_ref": "PROC/2011/ICT/009",
                "cost": 800_000,
                "acquisition_date": date(2011, 7, 20),
                "supplier": "Dawa Technologies Uganda Ltd",
                "current_custodian_id": None,
                "department": None,
            },
        ...
        for data in assets_data:
            asset = get_or_create_asset(db, **data)
            created_assets[asset.asset_id] = asset
        ...
        def assignment_exists(db, asset_id, assigned_to):
        ...
        assignments_data = [
            {
                ...
                "assignment_date": date(2023, 4, 20),
                "status": AssignmentStatus.ACTIVE,
                "notes": "Assigned for Legal department use.",
            },
            {
                "asset_id": "AST-ICT00001",
                "assigned_to": custodian1.user_id,
                "assigned_by": manager.user_id,
                "assignment_date": date(2024, 3, 12),
                "status": AssignmentStatus.ACTIVE,
                "notes": "Primary ICT custodian laptop.",
            },
            {
                "asset_id": "AST-VEH00002",
                "assigned_to": employee3.user_id,
                "assigned_by": manager.user_id,
                "assignment_date": date(2022, 9, 1),
                "status": AssignmentStatus.ACTIVE,
                "notes": "Assigned for Finance & Administration field operations.",
            },
            # A returned (historical) assignment
            {
                "asset_id": "AST-ICT00008",
                "assigned_to": employee2.user_id,
                "assigned_by": manager.user_id,
                "assignment_date": date(2021, 6, 1),
        ...
        for a in assignments_data:
            # idempotency: skip if active assignment for same asset+user exists
        ...
        maintenance_data = [
            # Truck under maintenance
            {
                ...
                "cost": 4_800_000,
                "next_service_date": date(2024, 10, 10),
                "recorded_by": manager.user_id,
            },
            # Periodic maintenance on Land Cruiser
            {
                "asset_id": "AST-VEH00001",
                ...
                "cost": 1_200_000,
                "next_service_date": date(2024, 7, 15),
                "recorded_by": manager.user_id,
            },
            # Server maintenance
            {
                "asset_id": "AST-ICT00010",
                "service_date": date(2024, 5, 20),
                ...
                "cost": 2_500_000,
                "next_service_date": date(2025, 5, 20),
                "recorded_by": custodian1.user_id,
            },
            # Printer maintenance
            {
                "asset_id": "AST-ICT00002",
                "service_date": date(2024, 2, 28),
                ...
                "cost": 320_000,
                "next_service_date": date(2025, 2, 28),
                "recorded_by": custodian1.user_id,
            },
        ]
        ...
        # ----------------------------------------------------------------
        # 6. AUDIT LOGS — at least 5 entries simulating system activity
        # ----------------------------------------------------------------
        ...
        audit_data = [
            ...
            },
            {
                ...
                "action": "CREATE",
                "table_affected": "users",
                "record_id": custodian1.user_id,
                "details": f"Created new user account for {custodian1.full_name} "
            ...
            },
            {
                ...
                "action": "UPDATE",
                "table_affected": "users",
                "record_id": employee2.user_id,
                "details": f"User account for {employee2.full_name} password reset by System Administrator.",
                "timestamp": now + timedelta(hours=3),
            },
            {
                "user_id": custodian1.user_id,
                "action": "CREATE",
                "table_affected": "maintenance_records",
                "record_id": "AST-ICT00010",
            ...
            },
            {
                ...
                "record_id": "AST-VEH00002",
                "details": f"Asset 'Toyota Hilux Double Cab' assigned to {employee3.full_name} "
        ...
        print("  │ Role                  │ Email                       │")
        print("  ├─────────────────────────────────────────────────────┤")
        print("  │ System Administrator  │ admin@ursb.go.ug            │")
        print("  │ Asset Manager         │ asset.manager@ursb.go.ug    │")
        print("  │ Asset Custodian (ICT) │ custodian.ict@ursb.go.ug   │")
        print("  │ Asset Custodian (Adm) │ custodian.admin@ursb.go.ug  │")
        print("  │ Employee              │ john.mukasa@ursb.go.ug      │")
        print("  └─────────────────────────────────────────────────────┘")
        print("  Passwords: Admin@1234 / Manager@1234 / Custodian@1234 / Employee@1234")
        print("")
