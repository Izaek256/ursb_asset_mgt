...
export default function Settings() {
    ...
    return (_jsxs("div", { className: "w-full flex flex-col gap-5 select-none font-sans", children: [successMessage && _jsx(SuccessBanner, { message: successMessage, onDismiss: () => setSuccessMessage(null) }), isLoadingSettings && (_jsxs("div", { className: "flex justify-center items-center gap-3 py-12 text-ink-dim", children: [_jsx(LoadingSpinner, {}), " Loading settings..."] })), settingsError && _jsx(ErrorMessage, { message: settingsError }), _jsx(PageHeader, { title: "Settings", subtitle: "Configure your account and system preferences" }), _jsxs(Tab.Group, { children: [_jsx(Tab.List, { className: "flex flex-wrap gap-1.5 p-1.5 bg-white border border-sky-cardBorder rounded-xl w-fit", children: TABS.map((tab) => (_jsx(Tab, { as: React.Fragment, children: ({ selected }) => (_jsx(Button, { variant: selected ? "primary" : "ghost", className: selected ? "" : "shadow-none border-transparent bg-transparent", children: tab })) }, tab))) }), _jsxs(Tab.Panels, { className: "mt-2", children: [_jsxs(Tab.Panel, { className: "bg-white border border-sky-cardBorder rounded-2xl p-8 sm:p-10 shadow-sm focus:outline-none", children: [_jsx("h3", { className: "font-bold text-base text-ink", children: "Profile" }), _jsx("p", { className: "text-sm text-ink-dim mt-1 mb-6", children: "Update your personal details." }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6", children: [
