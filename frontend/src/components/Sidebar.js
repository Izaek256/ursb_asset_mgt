...
export default function Sidebar({ collapsed, onToggleCollapse, activePath, onNavigate, }) {
    ...
    return (_jsxs("aside", { className: `fixed md:sticky top-0 left-0 h-screen z-40 flex flex-col bg-gradient-to-b from-sky-sidebarTop to-sky-sidebarBot border-r border-sky-border py-5 px-3 transition-all duration-350 ease-in-out shrink-0 select-none motion-reduce:transition-none ${collapsed ? "w-20" : "w-[250px]"}`, children: [_jsxs("div", { className: "flex items-center gap-2.5 px-2 pb-5 select-none", children: [_jsx("div", { className: "w-10 h-10 min-w-10 rounded-xl bg-gradient-to-br from-ursb to-ursb-dark flex items-center justify-center text-white font-bold text-base shadow-lg shadow-ursb/35 pointer-events-none", children: "U" }), _jsxs("div", { className: `flex flex-col overflow-hidden whitespace-nowrap transition-all duration-200 motion-reduce:transition-none ${collapsed ? "w-0 opacity-0" : "w-auto opacity-100"}`, children: [_jsx("span", { className: "font-bold text-sm text-ink leading-tight", children: "URSB Assets" }), _jsx("span", { className: "text-[11px] text-ink-dim font-medium mt-0.5", children: "Management Portal" })] })] }), _jsx("div", { className: `text-[10px] font-bold tracking-widest text-ink-dim uppercase mx-2.5 my-2 transition-opacity duration-200 select-none ${collapsed ? "opacity-0 h-0 my-0 overflow-hidden" : "opacity-100"}`, children: "Main Menu" }), _jsx("nav", { className: "flex-1 flex flex-col gap-1 overflow-y-auto px-1 select-none", children: visibleNav.map((item) => {
                ...
                }) }), _jsxs("div", { className: "select-none mt-auto", children: [_jsx("div", { className: "h-px bg-white/55 my-3 mx-1" }), _jsxs("div", { className: "flex items-center gap-2.5 p-2.5 rounded-xl bg-white/60 shadow-sm", children: [_jsx("div", { className: "w-9 h-9 min-w-9 rounded-full bg-gradient-to-br from-ursb to-ursb-dark text-white flex items-center justify-center text-xs font-bold pointer-events-none", children: userInitials }), _jsxs("div", { className: `flex flex-col overflow-hidden whitespace-nowrap transition-all duration-200 ${collapsed ? "w-0 opacity-0" : "w-auto opacity-100"}`, children: [_jsx("span", { className: "text-xs font-bold text-ink leading-tight truncate max-w-36", children: user?.full_name || "Robert Ssekandi" }), _jsx("span", { className: "text-[10px] text-ink-dim font-medium mt-0.5 truncate max-w-36", children: user?.role || "System Administrator" })] })] }), _jsxs(Button, { variant: "ghost", fullWidth: true, onClick: onToggleCollapse, className: "mt-2.5 border-dashed justify-start gap-2 text-xs text-ink-dim", children: [_jsx(ICONS.chevronLeft, { className: `w-4 h-4 transition-transform duration-350 shrink-0 motion-reduce:transition-none ${collapsed ? "rotate-180" : ""}` }), _jsx("span", { className: collapsed ? "hidden" : "", children: "Collapse" })] })] })] }));
}
